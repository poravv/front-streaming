...
const baseURL = process.env.REACT_APP_API_URL+'/tipo_cuenta';

export const getTipoCuenta = async ({token,param}) => {
...
export const deleteTipoCuenta  = async ({token,param}) => {
    //CONFIGURACION DE TOKEN
    const config = {
        headers: {
            "Authorization": `Bearer ${token}`,
...
export const updateTipoCuenta  = async ({token,param,json}) => {
    const config = {
        headers: {
            "Authorization": `Bearer ${token}`,
        }
...
export const createTipoCuenta  = async ({token,json}) => {
    //console.log(json)
    const config = {
        headers: {
            "Authorization": `Bearer ${token}`,
